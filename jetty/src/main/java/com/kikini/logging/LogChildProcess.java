 ...
 * directing {@code stdout} to {@link org.slf4j.Logger#info(String)} and {@code stderr} to
...
public class LogChildProcess {
    ...
    public static void main(String[] args) throws IOException {
        ...
        new Thread(new LineLogger(stdout, LineLogger.LogAtLevel.INFO)).start();
        InputStreamReader stderr = new InputStreamReader(new BufferedInputStream(p.getErrorStream()));
        new Thread(new LineLogger(stderr, LineLogger.LogAtLevel.ERROR)).start();
    }

...
/**
 * An implementation of {@link java.util.concurrent.Delayed} which rounds the delay up to the
...
class GranularDelay implements Delayed {
     ...
     *
     * @param granularityMillis The length of the time window. Must be greater than 0
     */

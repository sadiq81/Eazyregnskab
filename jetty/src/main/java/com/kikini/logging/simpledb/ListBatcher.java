...
/**
 * Class to aid in iterating through a {@link java.util.List} in batches of a particular
 * size
 *
 * @param <E> the type of {@link java.util.List} to batch
 * @author Gabe Nell
 */
class ListBatcher<E> {
    ...
    /**
     * Constructor to batch-iterate over the given {@link java.util.List}. The given
     * {@link java.util.List} is used directly, so any modifications to it will affect the
     * operation of this class.
     *
     * @param list      the {@link java.util.List} to iterate over.
     * @param batchSize the size of the sublist to return when calling
    ...
    /**
     * Returns a {@link java.util.List} of the batch size specified during construction.

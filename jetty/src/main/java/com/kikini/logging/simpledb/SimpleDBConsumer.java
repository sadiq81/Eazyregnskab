...
/**
 * {@link Runnable} to read from a {@link java.util.concurrent.BlockingQueue} of {@link SimpleDBRow}
 * s, and write them to a {@link SimpleDBWriter}. The thread will wait on
 * {@link java.util.concurrent.BlockingQueue#take()}, drain all the objects from the queue, then

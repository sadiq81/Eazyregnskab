 ...
 * @see DefaultDetailsTableAbove
 */
public class DetailsTableAbove<T, S> extends DataTable<T, S> {
     ...
     */
    public DetailsTableAbove(final String id, final List<IColumn<T, S>> columns, final IDataProvider<T> dataProvider, final int rowsPerPage) {

...
window.Feedback = function( options ) {
    ...
    options.nextLabel = options.nextLabel || "Fortsæt";
    options.reviewLabel = options.reviewLabel || "Gennemse";
    options.sendLabel = options.sendLabel || "Send";
    options.closeLabel = options.closeLabel || "Luk";
    
    options.messageSuccess = options.messageSuccess || "Din feedback blev sendt.";
    options.messageError = options.messageError || "Din feedback blev ikke sendt, prøv igen";
...
window.Feedback.Form = function( elements ) {
    ...
    this.elements = elements || [{
        type: "textarea",
        name: "Problem",
        label: "Beskriv det problem du oplever",
        required: false
    }];
...
window.Feedback.Screenshot.prototype.start = function( modal, modalHeader, modalFooter, nextButton ) {
    ...
    if ( this.h2cDone ) {
        ...
        blackoutButton = element("a", "Marker"),
        highlightButton = element("a", "Fremhæv"),
        previousElement;
        ...
        this.dom.appendChild( element("p", "Fremhæv eller marker det områder") );
